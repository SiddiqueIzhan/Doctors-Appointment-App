...
const AppointmentDetailsDialog = ({
  ...
  const {
    ...
    data: tokenData,
  } = useFetch(generateVideoSessionToken);
  ...
  const {
    ...
    fn: submitNotes,
    data: notesData,
  } = useFetch(addDoctorNotesForPatient);
  ...
  const isAppointmentActive = () => {
    ...
    return (
      (now - appointmentStartTime <= 30 * 60 * 1000 &&
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              <div className="h-5 w-5 text-emerald-400 mr-4">
                {otherPartyIcon}
              </div>
              <div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center">
                <Calendar className="h-5 w-5 text-emerald-400 mr-4" />
                <p className="text-white">
                  {formatDateTime(appointment.startTime.toString())}
                </p>
              </div>
              <div className="flex items-center">
                <Clock className="h-5 w-5 text-emerald-400 mr-4" />
                <p className="text-white">
